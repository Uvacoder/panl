        ...
        <aside class="tu-sidebar">
            <div class="tu-links">
                <div class="sidenav sidenav__hello">
                    <div class="logo mb-4">
                        <div class="logo-icon flex-column">
                                ...
                                <svg width="165px" height="67px" viewBox="0 0 165 67" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <defs>
                                        <linearGradient x1="0.25781251%" y1="49.7500002%" x2="101.257813%" y2="49.7500002%" id="linearGradient-1">
                                            ...
                                            <stop stop-color="#53A0FD" offset="76.770584%"></stop>
                    ...
                    <!--<p class="small">
                    Based on the idea that color is the most intuitive way to code, we've created a tool to make complex ideas easily accessible. And then help designers use the color groups to guide the design.  It can be used to showcase a color component structure in a more accessible way than a color wheel.
                    </p>-->
                  ...
                  <div class="hr border-bottom--gradient"></div>
                    ...
                    <div class="sidebar">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="h6 mb-0 " id="currentPalette">Selected</div>
...
<path xmlns="http://www.w3.org/2000/svg" d="M8.35964 14.0416C7.8303 14.1991 7.52889 14.7559 7.68643 15.2853C8.11874 16.7378 9.26213 17.8812 10.7147 18.3135C11.244 18.4711 11.8009 18.1697 11.9584 17.6403C12.1159 17.111 11.8145 16.5542 11.2852 16.3966C10.48 16.157 9.84298 15.52 9.60334 14.7148C9.4458 14.1854 8.88897 13.884 8.35964 14.0416Z" fill="#fff"></path>
                            ...
                            <div class="d-flex align-items-center">
                                <ul class="list-unstyled d-flex color-palette-list w-100">
                    ...
                    <div class="collapse background-light border-radius-4" id="collapseColors">
                        <div class="p-3">
...
<path xmlns="http://www.w3.org/2000/svg" d="M9 5C8.44772 5 8 5.44772 8 6C8 6.55228 8.44772 7 9 7C9.55228 7 10 6.55228 10 6C10 5.44772 9.55228 5 9 5ZM6.17071 5C6.58254 3.83481 7.69378 3 9 3C10.3062 3 11.4175 3.83481 11.8293 5H19C19.5523 5 20 5.44772 20 6C20 6.55228 19.5523 7 19 7H11.8293C11.4175 8.16519 10.3062 9 9 9C7.69378 9 6.58254 8.16519 6.17071 7H5C4.44772 7 4 6.55228 4 6C4 5.44772 4.44772 5 5 5H6.17071ZM15 11C14.4477 11 14 11.4477 14 12C14 12.5523 14.4477 13 15 13C15.5523 13 16 12.5523 16 12C16 11.4477 15.5523 11 15 11ZM12.1707 11C12.5825 9.83481 13.6938 9 15 9C16.3062 9 17.4175 9.83481 17.8293 11H19C19.5523 11 20 11.4477 20 12C20 12.5523 19.5523 13 19 13H17.8293C17.4175 14.1652 16.3062 15 15 15C13.6938 15 12.5825 14.1652 12.1707 13H5C4.44772 13 4 12.5523 4 12C4 11.4477 4.44772 11 5 11H12.1707ZM9 17C8.44772 17 8 17.4477 8 18C8 18.5523 8.44772 19 9 19C9.55228 19 10 18.5523 10 18C10 17.4477 9.55228 17 9 17ZM6.17071 17C6.58254 15.8348 7.69378 15 9 15C10.3062 15 11.4175 15.8348 11.8293 17H19C19.5523 17 20 17.4477 20 18C20 18.5523 19.5523 19 19 19H11.8293C11.4175 20.1652 10.3062 21 9 21C7.69378 21 6.58254 20.1652 6.17071 19H5C4.44772 19 4 18.5523 4 18C4 17.4477 4.44772 17 5 17H6.17071Z" fill="#fff"></path>
                    ...
                    <div class="sidebar-settings-wrapper mt-3">
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Hue <span class="hotpink">{{primaryHSL.h}} &#176;</span> </div>
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Saturation <span class="hotpink">{{primaryHSL.s}}</span></div>
                            <div class="sidebar-settings__control">
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Lightness <span class="hotpink">{{primaryHSL.l}}</span></div>
                            <div class="sidebar-settings__control">
                    ...
                    <div class="sidebar-settings-wrapper mt-3">
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Hue <span class="hotpink">{{accentHSL.h}} &#176;</span> </div>
                            <div class="sidebar-settings__control">
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Saturation <span class="hotpink">{{accentHSL.s}}</span></div>
                            <div class="sidebar-settings__control">
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Lightness <span class="hotpink">{{accentHSL.l}}</span></div>
                            <div class="sidebar-settings__control">
                    ...
                    <div class="sidebar-settings-wrapper mt-3">
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Hue <span class="hotpink">{{neutralHSL.h}} &#176;</span> </div>
                            <div class="sidebar-settings__control">
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Saturation <span class="hotpink">{{neutralHSL.s}}</span></div>
                            <div class="sidebar-settings__control">
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Lightness <span class="hotpink">{{neutralHSL.l}}</span></div>
                            <div class="sidebar-settings__control">
                                ...
                                <div class="card bg-transparent text-primary root-margins p-0" >
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="h1">PANL makes it easy. </div>
    ...
    <path xmlns="http://www.w3.org/2000/svg" d="M3 5C3 3.89543 3.89543 3 5 3H9C10.1046 3 11 3.89543 11 5V9C11 10.1046 10.1046 11 9 11H5C3.89543 11 3 10.1046 3 9V5ZM9 5H5V9H9V5ZM13 5C13 3.89543 13.8954 3 15 3H19C20.1046 3 21 3.89543 21 5V9C21 10.1046 20.1046 11 19 11H15C13.8954 11 13 10.1046 13 9V5ZM19 5H15V9H19V5ZM3 15C3 13.8954 3.89543 13 5 13H9C10.1046 13 11 13.8954 11 15V19C11 20.1046 10.1046 21 9 21H5C3.89543 21 3 20.1046 3 19V15ZM9 15H5V19H9V15ZM13 15C13 13.8954 13.8954 13 15 13H19C20.1046 13 21 13.8954 21 15V19C21 20.1046 20.1046 21 19 21H15C13.8954 21 13 20.1046 13 19V15ZM19 15H15V19H19V15Z" fill="#fff"></path>
                    ...
                    <div class="sidebar-settings-wrapper ">
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Base Font <span class="hotpink">{{baseFontSize}}pt</span></div>
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75 ">Padding <span class="hotpink">{{paddings/2}}rem</span></div>
                            <div class="sidebar-settings__control ps-2">
                                <!-- <Slider label="SaturationMaster" color-type="accent" channel="s"  :label-hidden="true" :min=0 :max=5 @colorChange="onSliderChange($event)"></Slider> -->
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Margins <span class="hotpink">{{margins/2}}rem</span></div>
                            <div class="sidebar-settings__control ps-2">
                                <!-- <Slider label="SaturationMaster" color-type="accent" channel="s"  :label-hidden="true" :min=0 :max=5 @colorChange="onSliderChange($event)"></Slider> -->
                        ...
                        <div class="sidebar-settings">
                            <div class="sidebar-settings__heading text-white-75">Border Rad. <span class="hotpink">{{borderRadius}}px</span></div>
                            <div class="sidebar-settings__control ps-2">
                                <!-- <Slider label="SaturationMaster" color-type="accent" channel="s"  :label-hidden="true" :min=0 :max=5 @colorChange="onSliderChange($event)"></Slider> -->
...
export default {
    ...
    methods: {
        ...
        onSliderMarginsChange(e) {
            ...
            SetRootProperty('--margins', `${this.margins / 2}rem`)
        ...
        setCurrentPalette(index) {
            ...
            //ANCHOR: COLLAPSE CODE
            // Close color palette
            document.getElementById('collapseColorsTrigger').click();
            document.getElementById('currentPalette').scrollIntoView({behavior: "smooth", block: "center", inline: "nearest"});
